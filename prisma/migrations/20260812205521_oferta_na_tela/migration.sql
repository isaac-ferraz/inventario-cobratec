/*
  ...
  - You are about to drop the column `ofertou` on the `Conversa` table. All the data in the column will be lost.
...
INSERT INTO "new_Conversa" ("carteira", "cpfPendente", "criadoEm", "dossie", "dossieEm", "encerradaEm", "id", "identificadaEm", "motivoEscalonamento", "nascimentoPendente", "nome", "responsavelId", "saldo", "siscobraCarcod", "siscobraDevcod", "situacao", "telefone", "ultimaMensagemEm", "vencidoDesde") SELECT "carteira", "cpfPendente", "criadoEm", "dossie", "dossieEm", "encerradaEm", "id", "identificadaEm", "motivoEscalonamento", "nascimentoPendente", "nome", "responsavelId", "saldo", "siscobraCarcod", "siscobraDevcod", "situacao", "telefone", "ultimaMensagemEm", "vencidoDesde" FROM "Conversa";
DROP TABLE "Conversa";
