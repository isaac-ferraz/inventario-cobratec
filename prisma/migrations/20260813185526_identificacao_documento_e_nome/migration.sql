/*
  ...
  - You are about to drop the column `cpfPendente` on the `Conversa` table. All the data in the column will be lost.
  - You are about to drop the column `nascimentoPendente` on the `Conversa` table. All the data in the column will be lost.
...
INSERT INTO "new_Conversa" ("carteira", "criadoEm", "dossie", "dossieEm", "encerradaEm", "id", "identificadaEm", "motivoEscalonamento", "nome", "oferta", "responsavelId", "saldo", "siscobraCarcod", "siscobraDevcod", "situacao", "telefone", "ultimaMensagemEm", "vencidoDesde") SELECT "carteira", "criadoEm", "dossie", "dossieEm", "encerradaEm", "id", "identificadaEm", "motivoEscalonamento", "nome", "oferta", "responsavelId", "saldo", "siscobraCarcod", "siscobraDevcod", "situacao", "telefone", "ultimaMensagemEm", "vencidoDesde" FROM "Conversa";
DROP TABLE "Conversa";
