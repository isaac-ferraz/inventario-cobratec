...
CREATE TABLE "new_Conversa" (
    ...
    "saldo" REAL,
    "vencidoDesde" TEXT,
    "ofertou" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_Conversa" ("carteira", "criadoEm", "dossie", "dossieEm", "encerradaEm", "id", "identificadaEm", "motivoEscalonamento", "nome", "responsavelId", "siscobraCarcod", "siscobraDevcod", "situacao", "telefone", "ultimaMensagemEm") SELECT "carteira", "criadoEm", "dossie", "dossieEm", "encerradaEm", "id", "identificadaEm", "motivoEscalonamento", "nome", "responsavelId", "siscobraCarcod", "siscobraDevcod", "situacao", "telefone", "ultimaMensagemEm" FROM "Conversa";
DROP TABLE "Conversa";
